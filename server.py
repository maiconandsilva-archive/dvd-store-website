...
app.add_url_rule('/account/personal-info', view_func=AccountPersonalInfoView.as_view('personal-info'))
app.add_url_rule('/account/address-info', view_func=AccountAddressInfoView.as_view('address-info'))
app.add_url_rule('/account/payments-info', view_func=AccountPaymentsInfoView.as_view('payments-info'))
